package com.mycro.micro.View.anim;/*
...
/**
 *
 * Author:canyan.zhang on 2024/9/9 15:31
 * Description：拷贝自androidx.recyclerview.widget.ItemTouchHelper，用于实现滑动回弹效果
 *
 */
 ...
 */
public class NItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    //Micro.zhangcanyan modify {@
    //public ItemTouchHelper(@NonNull ItemTouchHelper.Callback callback) {
    //mCallback = callback;
    //}
    //else
    public NItemTouchHelper(@NonNull Callback callback) {
        mCallback = callback;
    }
    //@}
        ...
        if ((flags & (LEFT | RIGHT)) != 0) {
            ...
            if (mVelocityTracker != null && mActivePointerId > -1) {
                ...
                if ((velDirFlag & flags) != 0 && dirFlag == velDirFlag
                        ...
                        //else
                        && absXVelocity >= mCallback.getSwipeEscapeVelocity(mSwipeEscapeVelocity, viewHolder)
                        //@}
        ...
        if ((flags & (UP | DOWN)) != 0) {
            ...
            if (mVelocityTracker != null && mActivePointerId > -1) {
                ...
                if ((velDirFlag & flags) != 0 && velDirFlag == dirFlag
                        ...
                        //else
                        && absYVelocity >= mCallback.getSwipeEscapeVelocity(mSwipeEscapeVelocity, viewHolder)
                        //@}
     ...
     * {@link NItemTouchHelper}.
     */
    public interface ViewDropHandler {

        /**
         * Called by the {@link NItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
         ...
         */
        //Micro.zhangcanyan delete {@
        //注释getSwipeEscapeVelocity方法
        //@SuppressWarnings("WeakerAccess")
         ...
         *                    it is cleared.
         * @param actionState One of {@link NItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link NItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link NItemTouchHelper#ACTION_STATE_DRAG}.
        ...
        //Flyme.zhangcanyan add {@
        //传递ViewHolder参数用于判断常驻与非常驻通知，实现不同滑动速度判断
        @SuppressWarnings("WeakerAccess")
        public float getSwipeEscapeVelocity(float defaultValue, @NonNull ViewHolder viewHolder) {
            return defaultValue;
        }
        //@}
    ...
    static class RecoverAnimation implements Animator.AnimatorListener {
         ...
         */
        public void update() {
            if (Float.compare(mStartDx, mTargetX) == 0) {
                mX = mViewHolder.itemView.getTranslationX();
            } else {
                mX = mStartDx + mFraction * (mTargetX - mStartDx);
            }
            if (Float.compare(mStartDy, mTargetY) == 0) {
